...
const cards = {
  blue1 : 'url(./assets/MythicCards/blue/blue1.png)',
  blue2 : 'url(./assets/MythicCards/blue/blue2.png)',
  ...
  blue6: 'url(./assets/MythicCards/blue/blue6.png)',
  blue7 : 'url(./assets/MythicCards/blue/blue7.png)',
  blue8 : 'url(./assets/MythicCards/blue/blue8.png)',
